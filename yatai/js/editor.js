...
(function (YH) {
  ...
  var STORAGE_KEY = 'yatai-hayashi-score/v3';

  /* 譜面の文字の既定サイズ（mm）。css/style.css の --kana-size と同じ値にする。
     この大きさを起点に、用紙に収まるところまで app.js が自動で下げる。 */
  var DEFAULT_SIZE = 4.0;
  YH.DEFAULT_SIZE = DEFAULT_SIZE;
  /* v2 … 印が語ごとに1つだった頃。保存キーの形が変わったので印だけ引き継がない */
  var PREV_KEY = 'yatai-hayashi-score/v2';
